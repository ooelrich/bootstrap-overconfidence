...
generate_one_line <- function(design_matrix, n_obs, deg_f, n_bss, sigma2, omega_0_1,
                              omega_0_2, a_0, b_0) {
...
generate_new_rows <- function(deg_f, n_bss, sigma_2, runs, design_mat, omega_0_1,
                              omega_0_2, a_0, b_0) {
    ...
    for (j in seq_len(runs)) {
        data_gen[j, ] <- generate_one_line(design_mat, n_obs, deg_f, n_bss,
                                           sigma_2, omega_0_1, omega_0_2, a_0, b_0)
        print(j)
    }
